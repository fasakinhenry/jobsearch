    ...
    <div className='relative min-h-screen bg-blue-50 font-sans overflow-hidden'>
      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        <main className='mt-8 md:mt-16'>
          ...
          <p className='text-gray-600 mb-6 md:mb-8 max-w-2xl text-sm md:text-base'>
          ...
          <div className='flex items-center bg-white rounded-full p-1 shadow-lg max-w-xl'>
            <input
              type='text'
              placeholder='Search jobs, companies, or keywords...'
              className='flex-grow px-3 md:px-4 py-2 text-sm md:text-base focus:outline-none'
            />
