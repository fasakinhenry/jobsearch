      ...
      <div className='flex flex-1 overflow-hidden'>
        <div className='w-80 border-r border-gray-200 overflow-y-auto'>
          ...
          <div className='p-6 border-b border-gray-200'>
            <div className='flex flex-col items-center'>
              ...
              <button className='mt-4 bg-green-600 text-white px-4 py-2 rounded-full text-sm'>
                Applied Job
              </button>
            </div>
          </div>
        ...
        <main className='flex-1 overflow-y-auto p-4 md:p-6'>
          <div className='relative z-10'>
            <div className='bg-green-600 text-white rounded-lg p-4 md:p-6 mb-6'>
              ...
              <div className='flex flex-col sm:flex-row'>
                ...
                />
                <button className='bg-green-700 hover:bg-green-800 rounded-lg sm:rounded-l-none px-6 py-2'>
                  Search
                </button>
              </div>
            </div>
